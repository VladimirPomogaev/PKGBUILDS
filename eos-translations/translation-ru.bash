...
_tr_add2 cal_info2                 "<b>Офлайн</b> вариант предоставляет рабочий стол %%s.\nИнтернет-подключение не требуется.\n\n"
_tr_add2 cal_info3                 "<b>Онлайн</b> вариант позволяет выбрать рабочий стол.\nТребуется интернет-подключение.\n\n"
_tr_add2 cal_info4                 "Внимание: Этот релиз находится в процессе разработки. Пожалуйста, сообщите нам в случае ошибки.\n"
_tr_add2 cal_info5                 "\nПосле установки рекомендуется обновить систему.\n\n"
_tr_add2 cal_info6                 "\nПосле установки система обновлена.\n\n"
...
_tr_add2 ins_starttip              "Запуcк установки EndeavourOS (выберите рабочее окружение)"
...
_tr_add2 after_install_us_from     "Обновление из"			                                            # AUR или вышерасположенный репозиторий
...
# 2020-Sep-11:
_tr_add2 after_install_ew2        "Выбор обоев EndeavourOS"      # было: "Обои EndeavourOS (выбрать)"
_tr_add2 after_install_ewtip2     "Средство выбора обоев"        # было: "Выберите из обоев EndeavourOS по умолчанию"
...
_tr_add2 install_community_tip        "Коллекция версий ОС от сообщества (в основном WM)"    # changed 2021-Oct-23, 2023-Jan-12
...
# 2022-Feb-16
_tr_add2 add_more_apps_qs            "Выбор популярных приложений для установки"                          # запускает eos-quickstart
